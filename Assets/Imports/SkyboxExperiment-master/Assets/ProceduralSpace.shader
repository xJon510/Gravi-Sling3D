	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif //aselc
				// --- Sun disabled (removed directional-light sun disc & glow) ---
				float4 baseColor = ( ( (( simplePerlin3D42 + simplePerlin3D44 )*0.1 + _DustAmount) * 0.1 ) + ( smoothstepResult25 * lerpResult40 ) + lerpResult248 + lerpResult258 );
